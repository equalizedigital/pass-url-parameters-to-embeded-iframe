...
define( 'RWC_Pass_Parameters_iframe', '1.1.0' );

// Load necesary JS
function rwc_pass_parameters_enqueue_script() { 
	wp_enqueue_script( 'rwc_pass_parameters_script', plugin_dir_url( __FILE__ ) . 'js/rwc-pass-parameters.js', array('jquery'), RWC_Pass_Parameters_iframe, true );
}
